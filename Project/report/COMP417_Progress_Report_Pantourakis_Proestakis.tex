...
%             bookmarksopen=true,
%             pdftitle={Εφαρμογή αλγορίθμων τεχνητού ανοσοποιητικού συστήματος για την επίλυση του προβλήματος του βέλτιστου σχεδιασμού γραμμής προϊόντων},
...
% Title and author
%
\title{COMP417 Artificial Intelligence\\
...
\author{Pantourakis Michail AM 2015030185\\
	Proestakis Ioannis AM XXXXXXXXXX\\
