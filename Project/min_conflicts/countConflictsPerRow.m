function conflictDiff = countConflictsPerRow(column, row,...
    ...
    %  of Crete
    %   
    % Description: We check what happens if we choose this row for our
    % queen. It counts the number of conflicts it avoids and the number of conflicts
    % it creates. It returns the difference of conflicts between the
    ...
    %             of the current state from the new state,the state we create if we
    %             choose this row.        
    %             
